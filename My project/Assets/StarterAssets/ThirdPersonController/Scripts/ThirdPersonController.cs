...
namespace StarterAssets
{
    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            Vector3 inputDirectionWorld = _mainCamera.transform.forward * inputDirection.z + _mainCamera.transform.right * inputDirection.x;
            ...
            else if (!isClimbing)
            {
                ...
                targetDirection = Quaternion.Euler(0.0f, _targetRotation, 0.0f) * Vector3.forward * targetSpeed;
            }
